...
<body>
    <div class="container" style="background-color: #e5e5e5;">
        ...
        <main style="background-color: #e5e5e5; display: flex; margin-top: 120px; justify-content: space-between;">
            <div class="box-trai-phong">
                <div class="loai-phong">
                    <div><h2>Các Hạn Phòng</h2></div>
                    <ul>
            ...
            <div class="box-phai-phong">
                <div class="box-phong">
                    <div class="img">
                        <img src="https://booking.muongthanh.com/images/hotels/hotels/original/muong-thanh-luxury-ha-long-centre-banner-2_1688700664.jpg">
                    </div>
                    <div class="content">
                        <h2>Mường Thanh Luxury Hạ Long Centre</h2>
                        <div class="tien-nghi">
                            <p>Tiểu khu 2, đường Hạ Long, phường Bãi Cháy, thành phố Hạ Long, tỉnh Quảng Ninh</p>
                        </div>
                        <div class="luoc-xem">
                            <p>30 reviews</p>
                        </div>
